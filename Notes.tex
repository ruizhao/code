...
\section{MVC}
Controller has delegate of view. view donÕt own the data they display. controller is the data source. 
Model wanna ÒtellÓ controller something, controller can listen to model(observation pattern)
...
\begin{lstlisting}
UIImage *image = [UIImage imageNamed:@Òfoo.jpgÓ];
\end{lstlisting}
